...
- The status message dialog can be accessed through the main menu, the status bar menu, Modern Contact List Toolbar,
...
Copyright (C) 2006-2010 Bartosz 'Dezeath' Bia³ek
